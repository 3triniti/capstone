    ...
    <>
      <div className="flex bg-slate-100 w-screen h-64 mt-2">
        <Link to="/" className="hover:shadow-slate-200">
          <img
            src={logo2}
            className="w-64 h-64 drop-shadow-lg hover:opacity-50"
            alt=""
          />
        </Link>
        <div className=" flex-wrap columns-2 pl-24 w-1/3 mt-4 mb-3">
        ...
        <div className="h-48 w-0.5 mt-8 ml-12 bg-white"></div>
        <div className="ml-24">
        ...
        <div className="h-48 w-0.5 mt-8 ml-28 bg-white"></div>
        <div>
          <div className="ml-28 mt-10 pb-16">
            <Link
              to="/contact"
          ...
          <div>
            <a href="Info@kauaiteaceremony">
              <FontAwesomeIcon
                icon={faEnvelope}
                className="w-7 h-7 text-teal-500 hover:text-slate-300 font-open text-sm ml-32"
              />
            </a>
          </div>
        </div>
