...
const CommunityOutreach = () => {
  return (
    <div>
      ...
      <div className=" w-4/6 h-1 mt-12 ml-96 bg-teal-500"></div>
      <div className="flex pt-10 mb-8">
        <img src={suehiroKids} className=" w-80 h-96 pl-12 -mt-8" alt="" />

        <div>
          <p className="font-open font-thin text-base text-black text-left ml-12 mr-10 mb-6 mt-4">
          ...
          <p className="font-open font-thin text-base text-black text-left ml-12 mr-10 mb-24">
          ...
          <div className=" w-4/6 h-1 mt-12 ml-10 bg-teal-500"></div>
          <p className="font-open font-thin text-base text-black text-left ml-36 mr-10 mt-20 mb-6">
          ...
          <p className="font-open font-thin text-base text-black text-left ml-36 mr-10 mb-20">
          ...
          <div>
            <img
              ...
              className=" w-96 h-72 -ml-72 -mt-96 mb-16"
              alt=""
            />
          </div>
        </div>
