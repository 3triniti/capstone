      ...
      <div>
        ...
        <div className="flex">
          <div className="flex mt-10 mb-16">
            <video
              src={RetreatVideo}
              className="ml-12 w-96 h-80 -mt-10"
              controls
              autoplay="true"
              muted
            ></video>
            ...
            <video
              src={RetreatVideo2}
              className="-ml-96 w-96 h-80 mt-72 pt-6"
              controls
              autoplay="true"
              muted
            ></video>
            ...
            <div>
              ...
              <p className="font-open font-thin text-lg text-black text-left ml-10 mr-12 mt-24">
              ...
              <div className=" w-full h-1 mt-32 -ml-52 bg-teal-500"></div>
              <div className="">
                <img
                  src={Retreat}
                  className="ml-96 w-1/2 h-72 mt-24 mb-10"
                  alt=""
                />
              </div>
              <div>
                <h1 className="-ml-96 -mt-80 text-left font-open font-thin text-4xl text-teal-400">
                  Let us serve you, and put your mind at ease
                  <p className="font-open font-thin text-lg text-black text-left mr-80 mt-12 mb-8 pr-48">
